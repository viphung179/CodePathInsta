...
import com.vphung.codepathinsta.LoginActivity
import com.vphung.codepathinsta.MainActivity
import com.vphung.codepathinsta.Post
import com.vphung.codepathinsta.R
import java.io.File
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.btnSubmit).setOnClickListener() {
            ...
            if (photoFile != null) {
                ...
                Toast.makeText(requireContext(), "Post was not submitted", Toast.LENGTH_SHORT).show()
            }
        }
